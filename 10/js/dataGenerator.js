...
const COMMENTS_MESSAGES = ['Всё отлично!', 'В целом всё неплохо.Но не всё.', 'Когда вы делаете фотографию, хорошо бы убирать палец из кадра.В конце концов это просто непрофессионально.', 'Моя бабушка случайно чихнула с фотоаппаратом в руках и у неё получилась фотография лучше.', 'Я поскользнулся на банановой кожуре и уронил фотоаппарат на кота и у меня получилась фотография лучше.', 'Лица у людей на фотке перекошены, как будто их избивают.Как можно было поймать такой неудачный момент ? !', 'Да это фоташоп!!!!!!!!', 'Мега фото! Просто обалдеть. Как вам так удалось?', 'И разве низя обойтись одним opacity: 0; или visibility: hidden; чтобы убрать визуально инпут.Зачем задавать ширину и высоту по 1px, браузер по умолчанию же добавляет ', 'всякие стили и скринридиры нормально такое читают, не ?', 'А зачем.chec__box давать position absolute ? ) Можно Inline - block и тогда никакие паддинги не нужны будут', 'Супер, но вот там еще одно состояние есть) неопределенное ))', 'А есть ли способ кастомно слилизовать нативный select так, что бы не был хуже какого то плагина типа select2, jqueryformstyler или кастомно написаного ?????', 'Ни знал что такое можно в css сделать.Класс! Магия какая - то!', 'И разве низя обойтись одним opacity: 0; или visibility: hidden; чтобы убрать визуально инпут.Зачем задавать ширину и высоту по 1px, браузер по умолчанию же добавляет ', 'всякие стили и скринридиры нормально такое читают, не ?', 'А зачем.chec__box давать position absolute ? ) Можно Inline - block и тогда никакие паддинги не нужны будут', 'Супер, но вот там еще одно состояние есть) неопределенное ))', 'А есть ли способ кастомно слилизовать нативный select так, что бы не был хуже какого то плагина типа select2, jqueryformstyler или кастомно написаного ?????', 'Ни знал что такое можно в css сделать.Класс! Магия какая - то!'];

const MIN_LIKES = 25;
const MAX_LIKES = 200;
const COMMENTS_LENGTH = COMMENTS_MESSAGES.length;
...
const randomeCommentsArr = () => {
  ...
  randomeList.length = getRandomeNum(1, COMMENTS_LENGTH);
  return randomeList;
};
